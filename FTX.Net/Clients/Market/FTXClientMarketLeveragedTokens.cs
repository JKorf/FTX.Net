...
namespace FTX.Net.Clients.Rest
{
    ...
    /// </summary>
    public class FTXClientMarketLeveragedTokens : IFTXClientMarketLeveragedTokens
    {
        // TODO Combine into other subclients?
        private readonly FTXClientMarket _baseClient;

        internal FTXClientMarketLeveragedTokens(FTXClientMarket baseClient)
        {
